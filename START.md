...
- Уровень JS **разный** (Java, C#, начальный JS) — **вайбкодинг**: архитектуру и код пишет ИИ, человек промптит и playtest'ит. **Код не открываем.**
...
**Вайбкодинг:** студент формулирует ТЗ промптами, проверяет в браузере, ведёт журнал промптов. Не читает и не пишет код на сдаче.
...
- [day-03/day-03.md](./day-03/day-03.md) — подробно: день 3 (2 пары)  
- [day-03/tasks/task-03.md](./day-03/tasks/task-03.md) — задание дня 3 для студентов (GitHub)  
- [day-04/day-04.md](./day-04/day-04.md) — подробно: день 4 (2 пары)  
- [day-04/tasks/task-04.md](./day-04/tasks/task-04.md) — задание дня 4 для студентов (GitHub)  
